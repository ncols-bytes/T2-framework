...
def main():
    ...
    mysql_table_loader = MysqlTableLoader(args.mysql_host, args.mysql_user, args.mysql_password, args.mysql_database)
    ...
    for table in tables:
        ...
        annotations = table_2_tags[table_id]
        ...
        batch_size = 1
        max_input_tok_length = 160
        max_input_col_num = 20
        max_input_ent_length = 10 * max_input_col_num
        ...
        for col_idx in range(len(headers)):
            ...
            for label in annotations[col_idx]:
