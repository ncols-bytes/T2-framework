...
class FilteringModel(BertPreTrainedModel):
    def __init__(self, config, is_simple=False):
        super(FilteringModel, self).__init__(config)
    ...
    def forward(self, input_tok, input_tok_type, input_tok_pos, input_tok_mask,
                column_header_mask, labels_mask, labels,
                histogram):
        
        # pdb.set_trace()
        tok_outputs, ent_outputs, ent_candidates_embeddings = self.table(input_tok, input_tok_type, input_tok_pos, input_tok_mask, None, None, None, None, None, None, None)
...
class VerificationModel(BertPreTrainedModel):
    def __init__(self, config, is_simple=False):
        super(VerificationModel, self).__init__(config)
